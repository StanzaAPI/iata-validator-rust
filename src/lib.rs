//! Official Rust Client for IATA Air Cargo AWB & Aviation Validator
...
impl IataValidatorClient {
    pub fn new(api_key: Option<String>, base_url: Option<String>) -> Self {
        let key = api_key
            ...
            .unwrap_or_default();
        let base = base_url.unwrap_or_else(|| "https://api.stanzaapi.com/iata-validator".to_string());
        ...
        Self {
            ...
            tool_url: "https://stanzaapi.com/tools/iata-validator",
        }
    }
